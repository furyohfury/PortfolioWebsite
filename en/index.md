...
## Артем Кузьминых ENGRISHO PAIGE
...
<div class="two-column-layout">
  ...
  <h3>Мои проекты</h3>
  <div class="game-grid">
    {% assign sorted_projects = site.projects | where: "lang", "en" | sort: "priority" %}
...
- Основы языка C#
    ...
    <div class="info-block">
      <h3>Образование</h3>
<b>МГТУ имени Н.Э. Баумана</b>, Москва<br>
Проектирование технических и технологических комплексов<br>
2015-2020
    </div>
